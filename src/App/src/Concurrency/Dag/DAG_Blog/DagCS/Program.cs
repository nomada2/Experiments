...
dm.Execute();*/
	...
	class MainClass
	{
		private static void ComputeForOneSecond(){
			Console.WriteLine ("Starting operation Thread ID {0}", System.Threading.Thread.CurrentThread.ManagedThreadId);
			System.Threading.Thread.Sleep (1000);
			Console.WriteLine ("Ending operation Thread ID {0}", System.Threading.Thread.CurrentThread.ManagedThreadId);
		}
